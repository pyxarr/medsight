      ...
      <View className="w-full gap-6">
        ...
        {otpState === "idle" && (
          <View className="items-center">
            {canResend ? (
              <Pressable onPress={handleResend}>
                <Text className="text-[#EC4899] text-sm font-medium">
                  Resend code
                </Text>
              </Pressable>
            ) : (
        ...
        <Button
          className={`w-full rounded-2xl h-14 ${
            isFilled && otpState !== "error" ? "bg-[#DB2777]" : "bg-[#FBCFE8]"
          }`}
        ...
        <Text className="text-xs text-gray-400 text-center">
          By signing in, you confirm that the information you provide is accurate and that you will use this platform responsibly.
        </Text>
      </View>
    </AuthShell>
  );
